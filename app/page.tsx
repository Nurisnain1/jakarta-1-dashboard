...
import Jakarta1ProductLobActive from "@/components/jakarta1-product-lob-active";
...
import Jakarta1ReportDeps from "@/components/jakarta1-report-deps";

export default function Home(){
  return <><Jakarta1ReportDeps/><Jakarta1DashboardV2/><Jakarta1LobDevicePerformance/><Jakarta1YoYStoreFilter/><Jakarta1DailyFocus/><Jakarta1TargetFocus/><Jakarta1ProductLobActive/><Jakarta1TargetFocus3PP/><Jakarta1TargetFocusVAS/><Jakarta1WeeklyM238/><Jakarta1Soh/><Jakarta1SohUpdateTrigger/><Jakarta1IncentiveAudit/><Jakarta1PromoSource/><script src="/jakarta1-enhancer.js?v=20260918-2" defer /><script src="/jakarta1-reason-labels.js?v=20260918-1" defer /><script src="/jakarta1-reason-week.js?v=20260918-1" defer /><script src="/jakarta1-area-fix.js?v=20260917-0345" defer /><script src="/jakarta1-ytd-fix.js?v=20260917-1" defer /><script src="/jakarta1-responsive.js?v=20260918-2" defer /><script src="/jakarta1-report-tools.js?v=20260918-8" defer /></>;
}
