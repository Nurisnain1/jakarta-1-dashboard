(()=>{
 ...
 function yearTotal(){
  ...
  setHTML(foot,`<tr class="border-t-2 bg-slate-100 font-black"><td class="whitespace-nowrap px-3 py-3 text-sm">GRAND TOTAL</td><td class="whitespace-nowrap px-3 py-3 text-sm">${money.format(v25)}</td><td class="whitespace-nowrap px-3 py-3 text-sm">${money.format(v26)}</td><td class="whitespace-nowrap px-3 py-3 text-sm">${g}</td></tr>`);
 }
 let scheduled=false;
